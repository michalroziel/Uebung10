...
scanf("%d", &choiceIndex);
    ...
    case 2:
        ...
        printf("the Resulting acceleration is : %.3f m/s^2.", resultingAcceleration);
...
/*
* quantities needed for the distance of an uniformly accelerated linear motion.
*/
...
/*
* quantities needed for the velocity of anuniformly accelerated linear motion.
*/
...
printf("Please choose one of the following physical motions to compute: \n\n");
printf("1. computation of distance for an uniform linear motion. \n\n");
printf("2. computation of distance for an uniformly accelerated linear motion.\n\n");
printf("3. computation of velocity for an uniformly accelerated linear motion.\n\n");
printf("4. quit program.\n\n");
...
scanf("%d", &choiceIndex);
    ...
    case 1:
        ...
        resultingDistance = computeDistUniLinearMotion(givenVelocity,timeStart,timeEnd);
    ...
    case 2:
        ...
        resultingDistance = computeDistUniLinearAccMotion(velocityStart,velocityEnd,givenAcceleration);
        printf("the Resulting doistance is : %.3f meters", resultingDistance);
    ...
    case 3:
       ...
       resultingVelocity = computeVelocityUniAccMotion(givenAcceleration,timeStart,timeEnd,velocityStart);
...
printf("Welcome to the physics calculator! Please choose one of the Points below!: \n\n");
